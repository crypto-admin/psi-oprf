/**
* Copyright UnionPay. All Rights Reserved.
* <p>
...
非0--error code
***************************************************/
int EccSign(const unsigned char *hash, unsigned int hash_len,
...
非0--error code
***************************************************/
int EccVerify(const unsigned char *hash, unsigned int hash_len,
